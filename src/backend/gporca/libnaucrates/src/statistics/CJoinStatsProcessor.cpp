									  ...
									  BOOL stats_are_join_children)
{
	...
	CExpressionArray *inner_join_conjuncts = NULL;
	...
	for (ULONG i = 1; i < num_stats; i++)
	{
		...
		CStatsPredJoinArray *join_preds_stats = NULL;
		CExpressionArray *step_conjuncts = NULL;
