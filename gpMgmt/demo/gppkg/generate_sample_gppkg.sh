...
case "$OS" in
centos*)
	cp ${CWDIR}/data/sample-0.0.1-noop.${ARCH}.rpm ${DESTINATION_GPPKG_PATH}/
;;
ubuntu*)
	cp ${CWDIR}/data/sample-0.0-1.${ARCH}.deb ${DESTINATION_GPPKG_PATH}/
;;
*)
	echo "unkown OS <$OS>" >&2
	exit 1;
